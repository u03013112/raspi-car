...
def main():
    ...
    sz_src   = 960   # source image size in pixel after squaring
    sz_out   = 960   # output pano image hight in pixel
    ml       = 160    # modified pixels from left
    ...
    if _debug>=2:
        cv2.imwrite("resizecroped.png",img)
    ...
    cv2.imwrite("regression.png",img)
